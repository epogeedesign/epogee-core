...
class Ep_Admin_Page
{
	...
	public function __construct() {
		add_action('admin_init', [&$this, 'InitTabs'], 10, 0);
	}
	...
	protected function RenderHeading() {
		...
		echo '<h1 class="ep-heading"><span class="ep-logo"></span>'
 ...
 * @since 1.0.0
 */
class Ep_Admin_Menu_Page extends Ep_Admin_Page
{
	function __construct($slug, $pageTitle, $titleTag, $menuTitle, $capability = 'manage_options', $icon = '', $position = NULL) {
		parent::__construct();
 ...
 * @since 1.0.0
 */
class Ep_Admin_Sub_Menu_Page extends Ep_Admin_Page
{
	function __construct($slug, $parentSlug, $pageTitle, $titleTag, $menuTitle, $capability) {
		parent::__construct();
