<?php
// Modified from https://github.com/WarriorRocker/angular-xo-core/blob/master/Includes/Api/Abstract/Objects/Term.class.php
...
class Ep_Abstract_Term
{
	...
	/**
	 * Amount of posts using the current term mapped from count.
	 * 
	 * @since 1.0.0
	 * 
	 * @var int
	 ...
	 * @since 1.0.0
	 *
	 * @param WP_Term|int $term The base term object.
	 * @param bool $meta Optionally include meta in term object.
	 * @param bool $fields Optionally include ACF fields in post object.
	 */
	public function __construct($term, $meta = false, $fields = false) {
		// Ensure the WP_Term object has been obtained
		$term = get_term($term);
